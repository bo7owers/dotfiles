...
<template>
  ...
  >
    ...
    <p class="text-red-900">{{ content }} <span class="font-bold underline">is false!</span></p>

    <p class="text-green font-bold mt-3">Do not share personal information online</p>
    <template #footer>
      <Button @click="toggle" class="my-class my-class-green" :label="`Close ${props.modalNumber}`" autofocus />
    </template>
  </Dialog>
