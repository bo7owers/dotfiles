...
<template>
    <footer class="container">
        ...
        <div class="icons row-center">
            <a
                href="https://indieweb.social/@bo7owers"
                target="_blank"
                rel="noopener noreferrer"
                class="icon icon-mastodon"
                :v-tippy="
                    'Mastodon profile of René Torres (Open link in a new tab)'
                "
                :aria-label="Mastodon profile of René Torres (Open link in a new tab)"
            >
                <svg
            ...
            <a
                href="https://github.com/bo7owers"
                target="_blank"
                rel="noopener noreferrer"
                class="icon icon-github"
                :v-tippy="
                    'Github profile of René Torres (Open link in a new tab)'
                "
                :aria-label="Github profile of René Torres (Open link in a new tab) "
            >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    preserveAspectRatio="xMidYMid meet"
            ...
            <a
                href="https://ca.linkedin.com/in/7orresrene"
                target="_blank"
                rel="noopener noreferrer"
                class="icon icon-linkedin"
                :v-tippy="
                    'LinkedIn profile of René Torres (Open link in a new tab)'
                "
                :aria-label="LinkedIn profile of René Torres (Open link in a new tab)"
            >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    preserveAspectRatio="xMidYMid meet"
